...
public class FitnessDemo 
{
    ...
    public static void main(String[] args) 
    {
        ...
        String loginChoice = userInput.nextLine();
        ...
        {
            Person newMember; 
            newMember = createPerson();
            System.out.println("This is the information associated with your new account:");
            TODO: 
            /*
                Add a confirmation message or see if the user wants to change anything.s
            */
